...
/// <summary>
/// プレビュー結果。全文と行境界を保持し、UI は preview.js で WinMerge 風に描画する。
/// </summary>
public class PreviewResult
{
    /// <summary>正規化済み全文。エラー時は 1 行のメッセージ。</summary>
    public string Content { get; init; } = "";

    /// <summary>各行の先頭インデックス。行数は配列長と同じ。</summary>
    public int[] LineStartOffsets { get; init; } = [0];

    /// <summary>行数。LineStartOffsets の要素数と同値。</summary>
